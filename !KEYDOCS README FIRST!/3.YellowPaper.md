...
Audits of Agents performed by Coders generating an "Agent Proof" that the stated functions of the Agent are as presented and contain no malicous code.

Placeholder for description of audit process, who can conduct audits and how to certify their outcomes, as well as incentives paid to auditors.
