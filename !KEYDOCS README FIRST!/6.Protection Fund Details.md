...
- Halting the Smart Contracts in case of an ongoing attack.
...
Before payments for damages can be determined, there should be conditions that trigger a halt of the Smart Contracts in the case of an ongoing attack.
