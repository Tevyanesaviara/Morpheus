...
Once MOR tokens are claimable and sendable, the Morpheus Network can enable MOR transactions to pay for API calls, custom agents, and validate the Stake of participants in the network. 
